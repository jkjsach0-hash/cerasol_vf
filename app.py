...
# =============================================================================
네, 가능합니다! 표의 행(가로줄)과 열(세로줄)을 뒤바꾸어 가로축이 월(1월~12월), **세로축이 연도(2023년, 2024년...)**가 되도록 수정하겠습니다.

이렇게 하면 연도별 전체 흐름을 가로로 길게 볼 수 있어 엑셀 장부와 비슷한 느낌을 줄 수 있습니다.

아래 코드를 복사해서 app.py 전체에 덮어씌워 주세요.
...
# [시트2] 냉각수 시트
URL_COOLING = "https://docs.google.com/spreadsheets/d/본인의_시트ID/export?format=csv&gid=12345678" 
